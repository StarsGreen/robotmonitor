...
DEP= $(TOPDIR)/common/socket_process.c $(TOPDIR)/common/video_get_thread.c\
	 $(TOPDIR)/common/monitor_process.c $(TOPDIR)/common/sensor_process.c\
$(TOPDIR)/common/video_broadcast_thread.c $(TOPDIR)/common/info_get_thread.c\
	$(TOPDIR)/common/move_ctl_thread.c $(TOPDIR)/common/cmd_process.c\
	...
	$(TOPDIR)/drivers/linklist.c $(TOPDIR)/drivers/sensor_read.c main.c
